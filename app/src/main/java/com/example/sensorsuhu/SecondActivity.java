    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (sensor == null){
            ...
            if (sensorManager.getDefaultSensor(Sensor.TYPE_AMBIENT_TEMPERATURE) != null){
                    ...
                    public void run() { // Function runs every MINUTES minutes.
                        ...
                        handler.post(
                                new Runnable()
                                {
                                    ...
                                    public void run()
                                    {
                                        Toast.makeText(SecondActivity.this, "Data berhasil ditambah", Toast.LENGTH_SHORT).show();
                                    }
                                }
                        );
                    }
                ...
                textX.setText("Sensor Suhu Tidak Ditemukan");
            }
        }
